// TODO: Does this belong inside my speakout.io folder?
...
// TODO: Does mine become wss://speakout.io:9449?
...
var options = {
    ...
    // TODO: What is my ca?
    // probably the full chain file but prob don't need it
};

// HTTPs server
// QUESTION: What is this doing? Creating an app that sends a webpage, but where?
var app = require('https').createServer(options, function(request, response) {
    response.writeHead(200, {
        'Content-Type': 'text/html'
    });

    //TODO: What do I replace this link with?
    //var link = 'https://github.com/muaz-khan/WebRTC-Experiment/tree/master/websocket-over-nodejs';
    //TODO: Replace wss:// link inside here to be mine
    //QUESTION: What is this injected HTML doing?
    ...
    //can replace later with other text
    response.write('hi');
    response.end();
});

// shared stuff
// QUESTION: What does shared stuff mean?
...
//QUESTION: what is this variable and string
...
// QUESTION: DO I remove local host?
